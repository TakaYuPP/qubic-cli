...
void print_help()
{
    ...
    printf("\t\tBuy QST: 0 = Qubic (QU), 1 = QSC. Seed and node required.\n");
    ...
    printf("\t-qusinotransferstarorqsc <DEST_IDENTITY> <AMOUNT> <1|2>\n");
    printf("\t\tTransfer: 1 = QSC, 2 = STAR. Seed and node required.\n");
    printf("\t-qusinostakeassets <AMOUNT> <DURATION> <ASSET_TYPE>\n");
    printf("\t\tStake: DURATION 1=1m, 2=3m, 3=6m, 4=12m; ASSET_TYPE 1=QSC, 2=STAR, 3=QST. Seed and node required.\n");
