...
// qip
uint32_t g_qip_ico_index = 0;
uint64_t g_qip_buy_token_amount = 0;
uint32_t g_qip_buy_token_phase = 0;
char* g_qip_issuer = nullptr;
char* g_qip_address1 = nullptr;
char* g_qip_address2 = nullptr;
char* g_qip_address3 = nullptr;
char* g_qip_address4 = nullptr;
char* g_qip_address5 = nullptr;
char* g_qip_address6 = nullptr;
char* g_qip_address7 = nullptr;
char* g_qip_address8 = nullptr;
char* g_qip_address9 = nullptr;
char* g_qip_address10 = nullptr;
char* g_qip_asset_name = nullptr;
uint64_t g_qip_price1 = 0;
uint64_t g_qip_price2 = 0;
uint64_t g_qip_price3 = 0;
uint64_t g_qip_sale_amount_phase1 = 0;
uint64_t g_qip_sale_amount_phase2 = 0;
uint64_t g_qip_sale_amount_phase3 = 0;
uint32_t g_qip_percent1 = 0;
uint32_t g_qip_percent2 = 0;
uint32_t g_qip_percent3 = 0;
uint32_t g_qip_percent4 = 0;
uint32_t g_qip_percent5 = 0;
uint32_t g_qip_percent6 = 0;
uint32_t g_qip_percent7 = 0;
uint32_t g_qip_percent8 = 0;
uint32_t g_qip_percent9 = 0;
uint32_t g_qip_percent10 = 0;
uint32_t g_qip_start_epoch = 0;
char* g_qip_transfer_asset_name = nullptr;
char* g_qip_transfer_issuer = nullptr;
uint64_t g_qip_transfer_number_of_shares = 0;
uint32_t g_qip_transfer_new_contract_index = 0;