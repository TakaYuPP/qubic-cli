...
enum COMMAND
{
    ...
    QBAY_SETTING_CFB_AND_QUBIC_PRICE = 105,
    QBAY_CREATE_COLLECTION = 106,
    QBAY_MINT_NFT = 107,
    QBAY_MINT_OF_DROP = 108,
    QBAY_TRANSFER = 109,
    QBAY_LIST_IN_MARKET = 110,
    QBAY_SELL = 111,
    QBAY_CANCEL_SELL = 112,
    QBAY_LIST_IN_EXCHANGE = 113,
    QBAY_CANCEL_EXCHANGE = 114,
    QBAY_MAKE_OFFER = 115,
    QBAY_ACCEPT_OFFER = 116,
    QBAY_CANCEL_OFFER = 117,
    QBAY_CREATE_TRADITIONAL_AUCTION = 118,
    QBAY_BID_ON_TRADITIONAL_AUCTION = 119,
    QBAY_GET_NUMBER_OF_NFT_FOR_USER = 120,
    QBAY_GET_INFO_OF_NFT_USER_POSSESSED = 121,
    QBAY_GET_INFO_OF_MARKETPLACE = 122,
    QBAY_GET_INFO_OF_COLLECTION_BY_CREATOR = 123,
    QBAY_GET_INFO_OF_COLLECTION_BY_ID = 124,
    QBAY_GET_INCOMMING_AUCTIONS = 125,
    QBAY_GET_INFO_OF_NFT_BY_ID = 126,
    QBAY_CHANGE_STATUS_OF_MARKET = 127,
    QBAY_TRANSFER_SHARE_MANAGAMENT_RIGHTS = 128,
