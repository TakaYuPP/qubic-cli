...
enum COMMAND
{
    ...
    QUSINO_GET_USER_ASSET_VOLUME,
    QUSINO_GET_USER_STAKING_INFO,
    QUSINO_GET_FAILED_GAME_LIST,
    QUSINO_GET_SC_INFO,
    QUSINO_GET_ACTIVE_GAME_LIST,
    QUSINO_BUY_QST,
    QUSINO_EARN_STAR,
    QUSINO_EARN_QSC,
    QUSINO_TRANSFER_STAR_OR_QSC,
    QUSINO_STAKE_ASSETS,
    QUSINO_SUBMIT_GAME,
    QUSINO_VOTE_IN_GAME_PROPOSAL,
    QUSINO_DEPOSIT_QST_FOR_SALE,
    QUSINO_TRANSFER_SHARE_MANAGEMENT_RIGHTS,
    PRINT_QSWAP_FEE,
    QSWAP_ISSUE_ASSET,
